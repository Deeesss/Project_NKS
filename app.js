...
const backgrounds = [
    'First-design.webp' // Zjednodušeno na jeden design
  ];
  ...
  const showHome = () => {
    ...
    document.getElementById('wallet-card').style.display = 'none';
    document.getElementById('mining-card').style.display = 'none';
    document.body.style.backgroundImage = "url('First-design.webp')";
    // Přidáno volání funkce showHome pro zobrazení domácí stránky jako výchozí
  };
